...
*/
echo '<br><p class="onlyinpro" style="font-size:16px; ">Available in Pro version and above. <a href="'.get_site_url().'/wp-admin/admin.php?page=cmreg_pro">UPGRADE NOW&nbsp;➤</a></p>';
