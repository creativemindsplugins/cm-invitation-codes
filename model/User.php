...
class User extends Model {
	...
	const META_INVITATION_CODES = 'cmreg_invitation_codes';
	...
	static function register($email, $password, $login, $displayName, $role = null) {
		...
		$errors = new \WP_Error();
		do_action( 'cm_register_post', $sanitized_user_login, $email, $errors );
...
// 		}
	...
	static function getEmailVerificationStatus($userId) {
		/*
		if (!App::isPro()) {
			return self::EMAIL_VERIFICATION_STATUS_VERIFIED;
		}
		*/
