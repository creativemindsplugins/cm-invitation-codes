...
if (!class_exists(__NAMESPACE__ . '\CmindsFreePackage')) {
    ...
    class CmindsFreePackage {
        ...
        public function updateMenu() {
            add_submenu_page($this->getOption('plugin-menu-item'), __('User Guide', 'cminds-package'), __('User Guide', 'cminds-package'), 'manage_options', $this->getPageSlug(), array($this, 'displayPage'), 4);
            if (!$this->getOption('plugin-free-only')) {
