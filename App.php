...
class App extends Core {
	...
	const PLUGIN_WEBSITE = 'https://www.cminds.com/wordpress-plugins-library/registration-and-invitation-codes-plugin-for-wordpress/';
	const TESTING = false;
	...
	static function init() {
		...
		wp_register_script('cmreg-form-builder', static::url('asset/vendors/form-builder/form-builder.js'), array('jquery', 'jquery-ui-core', 'jquery-ui-sortable'), "3.4.1", true);
		wp_register_script('cmreg-form-builder-render', static::url('asset/vendors/form-builder/form-render.min.js'), array('jquery', 'jquery-ui-core'), "3.4.1", true);
